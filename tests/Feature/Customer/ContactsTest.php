...
class ContactsTest extends TestCase
{
     ...
     * @var string
     */
    protected string $endpoint = 'customer/contacts';
     ...
     * @var string
     */
    protected string $repository = 'customerContact';
     ...
     * @return void
     */
    public function test_customer_contacts()
    {
        $this->getHttpMethod();
    }
     ...
     * @return void
     */
    public function test_customer_contacts_post_required_columns()
    {
     ...
     * @return void
     */
    public function test_customer_contacts_post()
    {
        $this->postHttpMethod();
    }
     ...
     * @return void
     */
    public function test_customer_contacts_put()
    {
        $this->putHttpMethod();
    }

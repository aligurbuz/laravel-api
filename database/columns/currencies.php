<?php return [
        'comments' => ["","","currency symbol ($,€ etc.)","currency name (EURO,USD etc.)","Indicates whether the symbol is to the right or left of the number.(0:left,1:right)","0:active 1:passive","0:notDeleted 1:deleted","","","","","",""],

...
namespace App\Repositories\Resources\Definition\Contracts;

use App\Models\Entities\Gender;
use App\Repositories\Resources\Definition\GendersRepository;

/**
 * @method $this id($id = null)
 * @method $this genderCode($gender_code = null)
 */
interface DefinitionGendersRepositoryContract
{
	/**
	 * @return array

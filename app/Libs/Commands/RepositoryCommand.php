...
class RepositoryCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $eventsDirectory = app_path() . '' . DIRECTORY_SEPARATOR . 'Repositories' . DIRECTORY_SEPARATOR . 'Traits' . DIRECTORY_SEPARATOR . '' . ucfirst($argumentName) . '' . DIRECTORY_SEPARATOR . 'Events';
        $eventsRepositoryDirectory = app_path() . '' . DIRECTORY_SEPARATOR . 'Repositories' . DIRECTORY_SEPARATOR . 'Traits' . DIRECTORY_SEPARATOR . '' . ucfirst($argumentName) . '' . DIRECTORY_SEPARATOR . 'Events' . DIRECTORY_SEPARATOR . '' . ucfirst($repositoryName);
        $propertyHandlersDirectory = app_path() . '' . DIRECTORY_SEPARATOR . 'Repositories' . DIRECTORY_SEPARATOR . 'Traits' . DIRECTORY_SEPARATOR . '' . ucfirst($argumentName) . '' . DIRECTORY_SEPARATOR . 'PropertyHandlers';
        $promotersDirectory = app_path() . '' . DIRECTORY_SEPARATOR . 'Repositories' . DIRECTORY_SEPARATOR . 'Traits' . DIRECTORY_SEPARATOR . '' . ucfirst($argumentName) . '' . DIRECTORY_SEPARATOR . 'Promoters';
        $promotersRepositoryDirectory = app_path() . '' . DIRECTORY_SEPARATOR . 'Repositories' . DIRECTORY_SEPARATOR . 'Traits' . DIRECTORY_SEPARATOR . '' . ucfirst($argumentName) . '' . DIRECTORY_SEPARATOR . 'Promoters' . DIRECTORY_SEPARATOR . '' . ucfirst($repositoryName);
        ...
        $directory = app_path() . '' . DIRECTORY_SEPARATOR . 'Repositories' . DIRECTORY_SEPARATOR . 'Traits' . DIRECTORY_SEPARATOR . '' . ucfirst($argumentName);
        $directoryContract = app_path() . '' . DIRECTORY_SEPARATOR . 'Repositories' . DIRECTORY_SEPARATOR . 'Traits' . DIRECTORY_SEPARATOR . '' . ucfirst($argumentName) . '' . DIRECTORY_SEPARATOR . 'Contracts';

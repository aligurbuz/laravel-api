...
/**
 * @property $this id
 * @property $this customer_image_code
...
class CustomerImage
{
	...
	/**
	 * get customer_image_code column for database table
	 *
	 * @return mixed
	 */
	protected static function customer_image_code(): mixed
	{
		return self::$query->customer_image_code;
	}

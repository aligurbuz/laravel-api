 ...
 * @property $this name
 * @property $this in_vars
 * @property $this in_colors
 * @property $this price
...
class Product
{
	...
	/**
	 * get in_vars column for database table
	 *
	 * @return mixed
	 */
	protected static function in_vars(): mixed
	{
		return self::$query->in_vars;
	}


	/**
	 * get in_colors column for database table
	 *
	 * @return mixed
	 */
	protected static function in_colors(): mixed
	{
		return self::$query->in_colors;
	}

 ...
 * @property $this super_admin_code
...
class SuperAdmin
{
	...
	/**
	 * get super_admin_code column for database table
	 *
	 * @return mixed
	 */
	protected static function super_admin_code(): mixed
	{
		return self::$query->super_admin_code;
	}

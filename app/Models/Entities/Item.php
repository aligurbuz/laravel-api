...
class Item
{
	...
	/**
	 * get sufficient_vary column for database table
	 *
	 * @return mixed
	 */
	protected static function sufficient_vary(): mixed
	{
		return self::$query->sufficient_vary;
	}

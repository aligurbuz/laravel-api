...
/**
 * @property $this id
 * @property $this permission_code
 * @property $this endpoint
...
class Permission
{
	...
	/**
	 * get permission_code column for database table
	 *
	 * @return mixed
	 */
	protected static function permission_code(): mixed
	{
		return self::$query->permission_code;
	}


	/**
	 * get endpoint column for database table
	 *
	 * @return mixed
	 */
	protected static function endpoint(): mixed
	{
